            ...
            with open(output_file_path, 'w') as outfile:
                ...
                for line1 in file1:
                    ...
                    for line2 in file2_lines:
                        ...
                        # This checks all overlap scenarios: partial overlaps from either direction
                        # and complete containment in either direction
                        if key1 == key2 and (range1_start <= range2_end and range2_start <= range1_end):
